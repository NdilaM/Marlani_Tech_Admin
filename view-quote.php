<?php
// view-quote.php - View a Single Quote
session_start();
...
/* ===== CUSTOM STYLES FOR VIEW QUOTE PAGE ===== */
.quote-container {
    background: #fff;
...
.totals-section { text-align: right; margin-top: 1.5rem; padding-top: 1.5rem; border-top: 2px solid #e3e6f0; }
.totals-section p { margin: 0.25rem 0; font-size: 1rem; }
.grand-total { font-size: 1.3rem; color: #1e3c72; font-weight: 800; }
                                ...
                                <div class="card-body">
                                    <div class="quote-container">
                                        ...
                                        <div class="totals-section">
                                            <p><strong>Subtotal:</strong> R <?php echo number_format($quote['total_amount'], 2); ?></p>
