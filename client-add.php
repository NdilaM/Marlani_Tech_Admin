                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="company_name" required value="<?php echo $_POST['company_name'] ?? ''; ?>" placeholder="Enter company name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Contact Person</label>
                                                <input type="text" class="form-control" name="contact_person" value="<?php echo $_POST['contact_person'] ?? ''; ?>" placeholder="Enter contact person name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label>Phone</label>
                                                <input type="text" class="form-control" name="phone" value="<?php echo $_POST['phone'] ?? ''; ?>" placeholder="Enter phone number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Notes</label>
                                            <textarea class="form-control" name="notes" rows="2" placeholder="Additional notes about this client"><?php echo $_POST['notes'] ?? ''; ?></textarea>
                                        </div>
